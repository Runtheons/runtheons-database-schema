...
LEFT JOIN (
    ...
    INNER JOIN users ON sath1.idUserAthlete = users.idUser
...
LEFT JOIN (
    ...
    INNER JOIN users ON sath2.idUserAthlete = users.idUser
...
LEFT JOIN (
    ...
    INNER JOIN users ON sath3.idUserAthlete = users.idUser
