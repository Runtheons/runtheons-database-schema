			...
			FROM (
				...
				FROM (
					SELECT products.*, 
						...
						reviews.comeBack,
						OLD_specialities.id AS speciality_id,
						OLD_specialities.description AS speciality_description
					FROM products
					INNER JOIN OLD_specialities ON OLD_specialities.id = products.idSpeciality
